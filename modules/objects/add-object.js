...
module.exports = function({connection, req}){
    return new Promise((resolve, reject)=>{
        const {objeto, descripcion, cantidad, id_importancia, id_categoria, usuario_creo} = req.body;
        ...
        connection.query(query, [objeto, descripcion, cantidad, id_importancia, id_categoria, 1, usuario_creo], (ex,{rows}) => {
            if (ex) {
              console.log(ex);
