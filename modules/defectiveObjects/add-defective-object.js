...
module.exports = function({connection, req}){
    return new Promise((resolve, reject)=>{
        ...
        const query = `INSERT INTO tb_defectuosos(id_objeto, motivo, cantidad, reparado, usuario_creo, fecha_creo) VALUES(?, ?, ?, ?, ?, NOW())`;
        ...
        connection.query(query, [id_objeto, motivo, cantidad, 0, usuario_creo], (ex,{rows}) => {
            if (ex) {
              console.log(ex);
