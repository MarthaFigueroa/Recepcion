module.exports = function({connection, req}){
    return new Promise((resolve, reject)=>{
        ...
        VALUES (?, ?, ?, ?, ?, ?, NOW())`;
        console.log(nombres, apellidos, dni, id_mascarilla, cantidad, usuario_creo);
        connection.query(query, [nombres, apellidos, dni, id_mascarilla, cantidad, usuario_creo], (ex,{rows}) => {
            if (ex) {
              console.log(ex);
