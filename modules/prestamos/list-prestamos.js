module.exports = function({connection, req}){
    ...
    if(start_date == null || end_date == null){
        ...
        const query = `SELECT obj.objeto as objeto, COUNT( id_objeto ) as prestamos FROM tb_prestamos prest, tb_objetos obj WHERE prest.id_objeto = obj.id AND hora_prestamo BETWEEN ? AND ? GROUP BY id_objeto`
        ...
        connection.query(query, [start_date, end_date], (ex, {rows})=>{
            if(ex){
                ...
                resolve({
                    data: rows,
                    msg: `Listado de prestamos entre las fechas ${start_date} y ${end_date}!`
                });
            }
        })
    }
